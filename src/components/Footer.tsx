            ...
            <div className="flex flex-col items-center md:items-end gap-8 md:gap-6">
              <div className="flex gap-6 md:gap-4">
                <a
                  ...
                  className="group p-4 md:p-3 bg-gray-800 hover:bg-[#25D366] rounded-full border border-gray-700 hover:border-transparent transition-all"
                >
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-black/95 backdrop-blur-xl border-t border-white/10 z-40 md:hidden">
        <div className="flex items-center justify-around py-4 px-6">
          ...
          <a
            ...
            className="flex flex-col items-center gap-1 text-white"
          >
            <div className="w-14 h-14 bg-cyan-500/20 rounded-full flex items-center justify-center border border-cyan-400/30 shadow-lg">
          ...
          <a
            ...
            className="flex flex-col items-center gap-1 text-white"
          >
            <div className="w-14 h-14 bg-blue-600/20 rounded-full flex items-center justify-center border border-blue-400/30 shadow-lg">
