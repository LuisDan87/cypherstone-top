...
export function ContactSection({ lang }: { lang: Language }) {
  ...
  return (
    <section
      id="contact"
      ref={ref}
      className={`relative py-16 md:py-20 pb-16 md:pb-20 px-4 md:px-6 transition-all duration-700 ${
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <div className="max-w-2xl mx-auto space-y-8">
          ...
          {/* WhatsApp oficial – tamaño perfecto */}
          <div className="flex justify-center">
            <a
              href="https://wa.me/5491138113906"
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#128C7E] rounded-full shadow-xl hover:shadow-cyan-500/40 transition-all duration-300 hover:scale-110"
              aria-label="WhatsApp"
            >
