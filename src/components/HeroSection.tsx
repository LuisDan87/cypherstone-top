  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center px-4 md:px-6 py-16 md:py-0 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-6 md:space-y-8">
        {/* LOGO MÁS GRANDE – ahora con clases que Tailwind SÍ incluye en producción */}
        <div className="mb-8 md:mb-16 animate-fade-in">
          <img
            src={logoImage}
            alt="CYPHERSTONE"
            className="h-40 sm:h-48 md:h-64 lg:h-80 xl:h-96 2xl:h-[500px] mx-auto drop-shadow-2xl"
            // ↑↑↑ Estas clases están 100 % seguras en cualquier build con purge
          />
        </div>
        ...
        <p style={{ letterSpacing: "1.5px", animationDelay: "0.4s" }} className="italic font-normal text-center text-muted-foreground animate-fade-in text-lg">
          {text.credibility}
        </p>
