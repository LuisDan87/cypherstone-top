...
const content = {
  es: {
    ...
    subheadline:
      "Acompañamos a empresarios, profesionales e inversores en la adopción segura y rentable de Bitcoin y DeFi, con absoluta discreción y metodología institucional.",
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
        ...
        {/* Subheadline */}
        <p className="text-lg md:text-xl lg:text-2xl font-light text-gray-light leading-relaxed max-w-3xl mx-auto animate-fade-in" style={{ animationDelay: "0.4s" }}>
          {text.subheadline}
        </p>
